...
size_t anonymous_save_fixed_length_bits(unsigned int *unsignintArray, size_t intArrayLength, unsigned char *result, unsigned int bit_count)
{
	...
	if (remainder_bit > 0)
	{
		...
		{
		case 1:
			anonymous_convertUInt2Byte_fast_1b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		case 2:
			anonymous_convertUInt2Byte_fast_2b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		case 3:
			anonymous_convertUInt2Byte_fast_3b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		case 4:
			anonymous_convertUInt2Byte_fast_4b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		case 5:
			anonymous_convertUInt2Byte_fast_5b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		case 6:
			anonymous_convertUInt2Byte_fast_6b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		case 7:
			anonymous_convertUInt2Byte_fast_7b_args(unsignintArray, intArrayLength, result + byte_offset);
			break;
		default:
...
size_t anonymous_convertUInt2Byte_fast_1b_args(unsigned int *intArray, size_t intArrayLength, unsigned char *result)
{
	size_t byteLength = 0;
	size_t i, j;
	if (intArrayLength % 8 == 0)
...
size_t anonymous_convertUInt2Byte_fast_2b_args(unsigned int *timeStepType, size_t timeStepTypeLength, unsigned char *result)
{
	unsigned char tmp = 0;
...
size_t anonymous_convertUInt2Byte_fast_3b_args(unsigned int *timeStepType, size_t timeStepTypeLength, unsigned char *result)
{
...
size_t anonymous_convertUInt2Byte_fast_4b_args(unsigned int *timeStepType, size_t timeStepTypeLength, unsigned char *result)
{
...
size_t anonymous_convertUInt2Byte_fast_5b_args(unsigned int *timeStepType, size_t timeStepTypeLength, unsigned char *result)
{
	size_t i = 0, k = 0, byteLength = 0, n = 0;
	if (timeStepTypeLength % 8 == 0)
...
size_t anonymous_convertUInt2Byte_fast_6b_args(unsigned int *timeStepType, size_t timeStepTypeLength, unsigned char *result)
{
	size_t i = 0, k = 0, byteLength = 0, n = 0;
	if (timeStepTypeLength % 8 == 0)
...
size_t anonymous_convertUInt2Byte_fast_7b_args(unsigned int *timeStepType, size_t timeStepTypeLength, unsigned char *result)
{
	size_t i = 0, k = 0, byteLength = 0, n = 0;
	if (timeStepTypeLength % 8 == 0)
...
size_t anonymous_extract_fixed_length_bits(unsigned char *result, size_t intArrayLength, unsigned int *unsignintArray, unsigned int bit_count)
{
	unsigned int byte_count = 0;
	unsigned int remainder_bit = 0;
	size_t i, j;
	...
	if (remainder_bit > 0)
	{
		...
		{
		case 1:
			anonymous_convertByte2UInt_fast_1b_args(intArrayLength, result + byte_offset, (intArrayLength - 1) / 8 + 1, unsignintArray);
			break;
		case 2:
			anonymous_convertByte2UInt_fast_2b_args(intArrayLength, result + byte_offset, (intArrayLength * 2 - 1) / 8 + 1, unsignintArray);
			break;
		case 3:
			anonymous_convertByte2UInt_fast_3b_args(intArrayLength, result + byte_offset, (intArrayLength * 3 - 1) / 8 + 1, unsignintArray);
			break;
		case 4:
			anonymous_convertByte2UInt_fast_4b_args(intArrayLength, result + byte_offset, (intArrayLength * 4 - 1) / 8 + 1, unsignintArray);
			break;
		case 5:
			anonymous_convertByte2UInt_fast_5b_args(intArrayLength, result + byte_offset, (intArrayLength * 5 - 1) / 8 + 1, unsignintArray);
			break;
		case 6:
			anonymous_convertByte2UInt_fast_6b_args(intArrayLength, result + byte_offset, (intArrayLength * 6 - 1) / 8 + 1, unsignintArray);
			break;
		case 7:
			anonymous_convertByte2UInt_fast_7b_args(intArrayLength, result + byte_offset, (intArrayLength * 7 - 1) / 8 + 1, unsignintArray);
			break;
		default:
...
void anonymous_convertByte2UInt_fast_1b_args(size_t intArrayLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
	size_t n = 0, i;
	unsigned int tmp;
...
void anonymous_convertByte2UInt_fast_2b_args(size_t stepLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
...
void anonymous_convertByte2UInt_fast_3b_args(size_t stepLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
	size_t i = 0, ii = 0, n = 0;
	unsigned char tmp = byteArray[i];
...
void anonymous_convertByte2UInt_fast_4b_args(size_t stepLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
	size_t i = 0, n = 0;
	unsigned char tmp;
	for (i = 0; i < byteArrayLength; i++)
...
void anonymous_convertByte2UInt_fast_5b_args(size_t stepLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
	size_t i = 0, ii = 0, n = 0;
	unsigned char tmp = byteArray[i];
	for (n = 0; n < stepLength;)
...
void anonymous_convertByte2UInt_fast_6b_args(size_t stepLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
	size_t i = 0, ii = 0, n = 0;
	unsigned char tmp = byteArray[i];
	for (n = 0; n < stepLength;)
...
void anonymous_convertByte2UInt_fast_7b_args(size_t stepLength, unsigned char *byteArray, size_t byteArrayLength, unsigned int *intArray)
{
	size_t i = 0, ii = 0, n = 0;
	unsigned char tmp = byteArray[i];
	for (n = 0; n < stepLength;)
